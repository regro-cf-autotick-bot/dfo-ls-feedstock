...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/dfo-ls-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14623&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/dfo-ls-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `dfo-ls` can be installed with:

```
conda install dfo-ls
```

It is possible to list all of the versions of `dfo-ls` available on your platform with:
